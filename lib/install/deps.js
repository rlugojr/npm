...
var loadDeps = exports.loadDeps = safe.recurseLimit(100, 1000, function loadDeps (tree, log, $$recurse$$, next) {
...
var flatNameFromTree = safe.recurseLimitSync(100, 1000, function (tree, $$recurse$$) {
  validate('OF', arguments)
  if (!tree.parent) return '/'
  var path = $$recurse$$(tree.parent)
  if (path !== '/') path += '/'
