...
var earliestInstallable = exports.earliestInstallable = function (requiredBy, tree, pkg) {
  ...
  // Install subdeps of bundled dependencies at highest in the bundled
  // dependency and not in the root of the tree.
  // This makes npm@3 produce packages installable by earlier 1.x npms.
  // See also: https://github.com/npm/npm/issues/9668
  function bundleMatch (bundled) {
    return bundled === tree.package.name
  }
  var bundled = tree.parent.package.bundleDependencies || []
  if (bundled.some(bundleMatch)) return tree
